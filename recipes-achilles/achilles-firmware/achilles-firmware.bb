...
SRC_URI += " \
	git://github.com/reflexces/achilles-hardware.git;destsuffix=hardware;name=hardware;protocol=https;branch=ghrd-v20.1 \
"

do_install () {
	cd ${WORKDIR}/hardware
	install -d ${D}${base_libdir}/firmware
	install -m 0644 output_files/fit_spl_fpga_periph_only.itb ${D}
	install -m 0644 output_files/fit_spl_fpga.itb ${D}

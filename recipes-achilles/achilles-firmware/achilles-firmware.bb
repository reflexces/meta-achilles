...
do_deploy () {
	...
	install -m 0644 precompiled/hps_isw_handoff/achilles-${SOM_VER}/hps.xml ${DEPLOY_DIR_IMAGE}
	install -m 0644 precompiled/rbf/achilles-${SOM_VER}/achilles_${SOM_VER}_ghrd.periph.rbf ${DEPLOY_DIR_IMAGE}
	install -m 0644 precompiled/rbf/achilles-${SOM_VER}/achilles_${SOM_VER}_ghrd.core.rbf ${DEPLOY_DIR_IMAGE}
}

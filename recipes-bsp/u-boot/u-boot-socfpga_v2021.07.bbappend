...
do_compile:append:${MACHINE}() {
	...
	mkimage -E -f ${S}/board/reflexces/${MACHINE}/fit_spl_fpga_periph_only.its ${B}/fit_spl_fpga_periph_only.itb
	mkimage -E -f ${S}/board/reflexces/${MACHINE}/fit_spl_fpga.its ${B}/fit_spl_fpga.itb
}
